...
typedef enum { TRNS_FAILED, TRNS_DISCONNECTED, TRNS_SUCCEEDED, TIME_OUT } TransferResult_t;
 ...
 * sd - the socket used for communication.
 */ 
TransferResult_t SendMsg(char* MessageToSend, SOCKET sd, int message_length);
 ...
 * TRNS_FAILED - otherwise
 */ 
TransferResult_t ReceiveMsg(char** recieved_msg, SOCKET sd);
